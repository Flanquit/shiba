...
<html lang="en">
    ...
    <head>
        ...
        <!-- MetisMenu CSS -->
        <link href="adminassets/js/metisMenu/metisMenu.min.css" rel="stylesheet">
                    ...
                    <div class="navbar-default sidebar" role="navigation">
                        <div class="sidebar-nav navbar-collapse">
                            <ul class="nav" id="side-menu">
                                ...
                                <li <?php echo (CURRENT_PAGE == "admin_news.php" || CURRENT_PAGE == "add_customer.php") ? 'class="active"' : ''; ?>>
                                    <a href="#"><i class="fa fa-user-circle fa-fw"></i> News<span class="fa arrow"></span></a>
                                    <ul class="nav nav-second-level">
                                        <li>
                                            <a href="admin_news.php"><i class="fa fa-list fa-fw"></i>List all</a>
                                        </li>
                                    <li>
